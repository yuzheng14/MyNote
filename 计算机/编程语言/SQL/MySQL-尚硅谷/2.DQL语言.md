...
![0cadea0db98ec91a5a5a0a806e8faec1](2.DQL语言.assets/0cadea0db98ec91a5a5a0a806e8faec1.png)
...
- limit语句放在查询语句的最后
- 公式：`limit (page-1)*size,size`    （page 要显示的页数，size每页的条目数）
